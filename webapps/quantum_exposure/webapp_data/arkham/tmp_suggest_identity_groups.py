...
EXPLICIT_GROUPS = {
    ...
    # Additional explicit suggestions from latest ungrouped refresh.
    "Yapizon.com": (GROUP_EXCHANGES, "high", "Korean exchange brand (later rebranded); exchange/custody venue."),
    "Btc38": (GROUP_EXCHANGES, "high", "Historic exchange venue label."),
    "Coinsecure": (GROUP_EXCHANGES, "high", "Exchange/brokerage service brand."),
    "BTCST.com": (GROUP_EXCHANGES, "medium", "Trading/service-domain style label; best fit is exchange venue."),
    "JokerStash": (GROUP_DARKNET, "high", "Known illicit-carding marketplace actor."),
    "EOBot": (GROUP_SCAMS, "high", "Cloud-mining service widely associated with scam/fraud outcomes."),
    "Tails": (GROUP_DARKNET, "medium", "Privacy/darknet-adjacent operational label."),
    "Bitstarz.com": (GROUP_CASINOS, "high", "Online casino / betting brand."),
    "Ripio": (GROUP_EXCHANGES, "high", "LatAm brokerage/exchange platform."),
    "SimpleFX": (GROUP_EXCHANGES, "medium", "Trading platform / brokerage-style label."),
    "Urdubit.com": (GROUP_EXCHANGES, "high", "Exchange/brokerage domain label."),
    "coins.co.th": (GROUP_EXCHANGES, "high", "Regional exchange/brokerage service."),
    "Cryptonator": (GROUP_PAYMENTS, "high", "Wallet/payments service branding."),
    "DSX": (GROUP_EXCHANGES, "high", "Exchange venue label."),
    "Bitmixer.io": (GROUP_DARKNET, "high", "Bitcoin mixer/tumbling service label."),
    "Coinapult": (GROUP_PAYMENTS, "medium", "Wallet/payments-style service brand."),
    "CoinRail": (GROUP_EXCHANGES, "high", "Exchange brand."),
    "I-obmen": (GROUP_EXCHANGES, "medium", "Exchange service label by naming."),
    "Abraxas": (GROUP_DARKNET, "high", "Known darknet market label."),
    "Alex Mashinsky": (GROUP_INDIVIDUALS, "high", "Person-labeled identity."),
    "Bitbank.com": (GROUP_EXCHANGES, "high", "Exchange/brokerage domain label."),
    "Bitgrail": (GROUP_EXCHANGES, "high", "Exchange brand."),
    "CCEDK": (GROUP_EXCHANGES, "high", "Exchange venue label."),
    "CoinEgg": (GROUP_EXCHANGES, "high", "Exchange brand."),
    "Coinify": (GROUP_PAYMENTS, "high", "Merchant payments processor / payments infrastructure brand."),
    "DMALockerv3": (GROUP_SCAMS, "high", "Locker/ransomware-family style label."),
    "Komodo": (GROUP_PROTOCOLS, "high", "Protocol / blockchain ecosystem label."),
    "MATBEA": (GROUP_EXCHANGES, "medium", "Exchange-service label by naming."),
    "NegocieCoins.com.br": (GROUP_EXCHANGES, "high", "Regional exchange/brokerage domain label."),
    "SynAck": (GROUP_SCAMS, "high", "Known ransomware/cybercrime actor label."),
    "UnixCoin": (GROUP_SCAMS, "medium", "Coin/project label linked to fraud-risk context; provisional scam bucket."),
    "ACX.io": (GROUP_EXCHANGES, "high", "Exchange domain brand."),
    "Atlas Quantum": (GROUP_SCAMS, "high", "Widely reported fraud/Ponzi-style scheme label."),
    "BiKi.com": (GROUP_EXCHANGES, "high", "Exchange domain brand."),
    "BISS": (GROUP_EXCHANGES, "medium", "Exchange-style venue acronym label."),
    "Bitcomaker": (GROUP_EXCHANGES, "medium", "Exchange-service style branding."),
    "BitFlip": (GROUP_EXCHANGES, "medium", "Brokerage/exchange naming pattern."),
    "Bitkonan": (GROUP_EXCHANGES, "high", "Exchange/brokerage brand."),
    "BitLendingClub": (GROUP_INSTITUTIONS, "medium", "Lending/finance service label; best fit institutional bucket."),
    "BitOasis": (GROUP_EXCHANGES, "high", "Regional exchange/brokerage brand."),
    "Bitsonic": (GROUP_EXCHANGES, "high", "Exchange venue label."),
    "BSave.io": (GROUP_PAYMENTS, "medium", "Wallet/savings/payments style branding."),
    "Changelly": (GROUP_EXCHANGES, "high", "Instant exchange/swap service brand."),
    "Cloud Token": (GROUP_SCAMS, "high", "Known scam/fraud-labeled token ecosystem."),
    "Coineal": (GROUP_EXCHANGES, "high", "Exchange brand."),
    "CrimeNet.biz": (GROUP_DARKNET, "high", "Illicit-market / cybercrime service label."),
    "DavorCoin": (GROUP_SCAMS, "high", "Known Ponzi/scam project label."),
    "Dispenser.tf": (GROUP_PAYMENTS, "medium", "Automated dispenser/service label; best fit payments tooling."),
    "Exp Asset": (GROUP_SCAMS, "high", "Ponzi."),
    "GoEx.pro": (GROUP_EXCHANGES, "high", "Exchange domain brand."),
    "GoUrl": (GROUP_PAYMENTS, "high", "Crypto payments gateway / merchant integration service."),
    "Nova": (GROUP_EXCHANGES, "medium", "Exchange-style venue label by usage context."),
    "Open Ledger": (GROUP_EXCHANGES, "high", "Exchange/trading venue brand."),
    "Ccex": (GROUP_EXCHANGES, "high", "Historic centralized exchange brand."),
    "Jed McCaleb": (GROUP_INDIVIDUALS, "high", "Person-labeled identity."),
    "Mohammad Ghorbaniyan": (GROUP_INDIVIDUALS, "high", "Person-labeled identity."),
    "Reddit Bitcoin Faucet": (GROUP_PAYMENTS, "high", "Faucet/payments distribution service label."),
    "UniCCShop": (GROUP_DARKNET, "high", "Known illicit carding marketplace/shop label."),
    "BitYes": (GROUP_EXCHANGES, "high", "Exchange/brokerage venue label."),
    "Igot": (GROUP_EXCHANGES, "high", "Exchange/brokerage venue label."),
    "Leancy.com": (GROUP_EXCHANGES, "medium", "Exchange-style service domain label."),
    "Linode Hacker": (GROUP_SCAMS, "high", "Hacker-linked compromise label."),
    "mexbt.com": (GROUP_EXCHANGES, "high", "Exchange domain label."),
    "Bit-Z": (GROUP_EXCHANGES, "high", "Exchange venue brand."),
    "Bit2Me": (GROUP_EXCHANGES, "high", "Exchange/brokerage platform brand."),
    "Bitcoinica Hacker": (GROUP_SCAMS, "high", "Hacker/theft-linked label."),
    "BTC Guild": (GROUP_MINING, "high", "Historic Bitcoin mining pool."),
    "BTC-Alpha": (GROUP_EXCHANGES, "high", "Exchange venue brand."),
    "CryptoLocker": (GROUP_SCAMS, "high", "Known ransomware/cybercrime label."),
    "DiceNow.com": (GROUP_CASINOS, "high", "Dice gambling brand."),
    "HolyTransaction": (GROUP_PAYMENTS, "high", "Wallet/payments service brand."),
    "IceDice.com": (GROUP_CASINOS, "high", "Dice gambling brand."),
    "KaratBit": (GROUP_SCAMS, "medium", "High-risk investment/project label; provisional scam bucket."),
    "Vault Of Satoshi": (GROUP_EXCHANGES, "high", "Historic exchange/custody platform label."),
    "Wyre": (GROUP_PAYMENTS, "high", "Payments/fiat-crypto rails and wallet infrastructure company."),
    "xCoin.io": (GROUP_EXCHANGES, "medium", "Exchange-style domain label; provisional venue bucket."),
}
